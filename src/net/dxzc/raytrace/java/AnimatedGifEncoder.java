...
public class AnimatedGifEncoder {
    ...
    public boolean addFrame(BufferedImage paramBitmap) {
        boolean ok = true;
    ...
    protected int findClosest(int paramInt) {
        ...
        int r = (paramInt >>> 16) & 0xFF;
        int g = (paramInt >>> 8) & 0xFF;
        int b = paramInt & 0xFF;
        int minpos = 0;
    ...
    protected void getImagePixels() {
        ...
        image.getRGB(0, 0, w, h, arrayOfInt, 0, w);
        int k = 0;
        int l = 0;
        int i1 = w;
        int localObject = 0;
        while (true) {
            ...
            if (localObject >= arrayOfInt.length)
                return;
            pixels[localObject * 3] = (byte) (arrayOfInt[localObject] >>> 16);
            pixels[localObject * 3 + 1] = (byte) (arrayOfInt[localObject] >>> 8);
            pixels[localObject * 3 + 2] = (byte) (arrayOfInt[localObject]);
            ++localObject;
        }
    }
